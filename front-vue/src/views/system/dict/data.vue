  ...
  <div class="app-container">
    <div class="dashboard-container">
      ...
      <el-card style="margin-top: 10px">
        <div slot="header">
          <span class="overview-header-title">{{ dictName }}</span>
  ...
  methods: {
    ...
    calculateTableHeight() {
      this.$nextTick(() => {
        if (this.$refs.searchCard) {
          ...
          this.tableHeight = windowHeight - searchCardHeight - 270;
        }
      });
    },
    /** 查询字典类型详细 */
    ...
    handleQuery() {
      ...
      const selectedOption = this.typeOptions.find(
        (item) => item.dictType === this.queryParams.dictType
      );
      if (selectedOption) {
        // 将选中选项的字典名称赋值给 this.dictName
        this.dictName = selectedOption.dictName;
      }
      this.getList();
    },
    /** 返回按钮操作 */
