...
service.interceptors.request.use(
  (config) => {
    ...
    // config.headers['X-JWT-TOKEN'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsInJvbGVzIjpbIkFETUlOIl0sImlzcyI6Im9kaW4ifQ.JbKp7XDmkmGBKQNe0CIOZBSxoaXLQcbOqaLI8Mij_MQ'
...
service.interceptors.response.use(
  (res) => {
    ...
    if (code === 401) {
      ...
      if (!isRelogin.show) {
        isRelogin.show = true;
        MessageBox.confirm("对不起，您的账号已停用！", "系统提示", {
