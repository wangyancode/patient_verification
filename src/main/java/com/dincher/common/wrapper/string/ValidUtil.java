...
public class ValidUtil {
  ...
  /** 负数 */
  private static final String V_NEGATIVE_NUMBER = "^-[1-9]\\d*|0$";
  ...
  /** 验证密码(数字和英文同时存在) */
  private static final String V_PD_REG = "[A-Za-z]+[0-9]";

  /** 验证密码长度(6-18位) */
  private static final String V_PD_LENGTH = "^\\d{6,18}$";
  ...
  public static boolean negatineNumber(String value) {
    return match(V_NEGATIVE_NUMBER, value);
  }
  ...
  public static boolean numberLength(String value) {
    return match(V_PD_LENGTH, value);
  }
