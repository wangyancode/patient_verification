//package com.dincher.framework.aspectj;
//
...
//
//    // 配置织入点
//    @Pointcut("@annotation(com.dincher.framework.aspectj.lang.annotation.DataScope)")
...
//                Field[] allFields = params.getClass().getDeclaredFields();
//                Class tempClass = params.getClass().getSuperclass();
...
//                        val.put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
//                        ReflectUtils.invokeSetter(params, field.getName(), val);
//                        break;
//                    }
//                }
//            }
//            /*if (StringUtils.isNotNull(params) && params instanceof CommonEntity) {
//                CommonEntity commonEntity = (CommonEntity) params;
//                commonEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
//            }*/
//        }
//    }
//
