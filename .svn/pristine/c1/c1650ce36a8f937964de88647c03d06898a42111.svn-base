  ...
  <div>
    <div class="app-container">
      <el-card ref="searchCard" class="search-box">
        ...
        <div>
          ...
          >
            ...
            <!--              <el-input v-model="queryParams.roleKey" placeholder="请输入权限字符" clearable @keyup.enter.native="handleQuery" />-->
            <!--            </el-form-item>-->
      ...
      <el-card style="margin-top: 10px">
        <div slot="header">
          <span class="overview-header-title">角色管理列表</span>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.roleId = row.roleId || this.ids;
    ...
    dealDelChange() {
      // 删除成功后写下以下判断
      let totalPage = Math.ceil((this.total - 1) / this.queryParams.pageSize);
      let currentPage =
