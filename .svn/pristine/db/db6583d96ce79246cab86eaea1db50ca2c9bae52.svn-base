<template>
  <div class="app-container">
    <el-card
      ref="searchCard"
      style="margin-bottom: 1vh; overflow: auto"
      class="search-box"
    >
      <div slot="header">
    ...
    <el-card style="overflow: auto">
      <div class="searchList">
        <div slot="header">
          <span class="overview-header-title">菜单管理列表</span>
        </div>
        <div class="searchList_btn">
      ...
      <div>
        ...
        >
          ...
          <el-table-column
            ...
            :show-overflow-tooltip="true"
          ></el-table-column>
          <el-table-column align="center" prop="icon" label="类型">
            <template slot-scope="scope">
              <div v-if="scope.row.menuType == 'M'" style="color: #2c9ef7">
                目录
              </div>
              <div v-if="scope.row.menuType == 'C'" style="color: #68ca88">
                菜单
              </div>
              <div v-if="scope.row.menuType == 'F'" style="color: #fe9400">
                按钮
              </div>
            </template>
          </el-table-column>
      ...
      >
        ...
        >
          ...
          <!-- 
          <el-form-item prop="isFrame" v-if="form.menuType != 'F'" style="width:45%">
            <span slot="label">
          ...
          <el-form-item prop="query" v-if="form.menuType == 'C'">
            <el-input
              v-model="form.query"
              placeholder="请输入路由参数"
              maxlength="255"
          ...
          <el-form-item prop="visible" v-if="form.menuType != 'F'">
            ...
            <el-radio-group v-model="form.visible" style="width: 240px">
              <el-radio
...
export default {
  ...
  methods: {
    ...
    calculateTableHeight() {
      this.$nextTick(() => {
        if (this.$refs.searchCard) {
          ...
          this.tableHeight = windowHeight - searchCardHeight - 243;
        }
      });
    },
    // 选择图标
    ...
    /** 查询菜单列表 */
    getList() {
      this.queryParams = strTrim(this.queryParams);
      this.loading = true;
