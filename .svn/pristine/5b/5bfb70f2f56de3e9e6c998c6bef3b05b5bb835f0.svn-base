package com.dincher.common.utils.http;
...
public class HttpUtils
{
    ...
    {
        return sendGetCk(url, param, Constants.GBK,cookie);
    }
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendGetCk(String url, String param, String contentType,String cookie)
    {
        StringBuilder result = new StringBuilder();
        BufferedReader in = null;
        try
