...
import com.dincher.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     */
    public static Map<Integer , String > getExcelPropertyFields(Class clazz){
        ...
        for (Field field : tempFields) {
            ...
            if (field.isAnnotationPresent(ExcelProperty.class)) {
                ...
                map.put(excel.index() , excel.value()[0]);
            }
        }
        return map;
    }
    ...
    public static String isNullReturnZero(String s){
        return isBlank(s) || "-".equals(s) ? "0" : s ;
    }
